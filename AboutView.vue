<template>
  <div>
    ...
    <label for="text-input">Text:</label><!-- 8.a) v-model with <input type="text"> -->
    ...
    <label for="select-input">Select your Drink:</label> <!-- 8.a) Select Dropdown -->
    ...
    <label for="textarea-input">Text here:</label> <!-- 8.a) Textarea for multiline text input -->
    <textarea id="textarea-input" v-model="textareaInput"></textarea>
    <p>Text Value: {{ textareaInput }}</p>

    <h2>v-model Modifiers</h2>

   
    <label for="lazy-input"> modifier :</label> <!-- 8.b) v-model modifier, .lazy Modifier -->
